...
This script directly uses ResNet20 model to perform localization of one magnet, retrieving position values in x, y, z directions
...
async def run_queue_consumer(queue: asyncio.Queue):
    model = keras.saving.load_model('ResNet20_model_lr0.001_epochs200_batch16_allsamples_zeropadding388_input344.keras')
    scalerx = joblib.load('scaler_ResNet20_allsamples_x.joblib') 
    scalery = joblib.load('scaler_ResNet20_allsamples_y.joblib')
    scalerz = joblib.load('scaler_ResNet20_allsamples_z.joblib')
...
###Initialization for rolling median
    ...
    while True:
        ...
        plot_cv2localization_30(np.array(initial_guess)*1000,grid_canvas) ## single magnet
        print(f"x1:{initial_guess[0]*1000}, y1:{initial_guess[1]*1000}, z1:{initial_guess[2]*1000}")
